...
public struct Platform {
    ...
    public var isCatalyst: Bool { variant == .catalyst }
    public var isAppKit: Bool { base == .macOS && variant == .normal }
    public var isUIKit: Bool { base == .iOS || base == .tvOS || isCatalyst }
    public var isSimulator: Bool { variant == .simulator }
    public var isLinux: Bool { base == .linux }
}
